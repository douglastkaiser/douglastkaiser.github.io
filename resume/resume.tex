...
\section{Summary}
Senior real-time controls and GNC engineer with $\sim$10 years building deterministic flight software, high-fidelity closed-loop simulations, and HIL test infrastructure for crewed and uncrewed vehicles --- eVTOL, autonomous fixed-wing, fusion plasma control, and spacecraft attitude. Cornell-trained spacecraft ACS lead returning to space with focus on attitude dynamics, control-law design, sensor fusion, and V\&V for commercial space stations.
